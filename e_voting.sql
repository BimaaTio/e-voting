...
VALUES (
        ...
        'adminn',
        'admin@gmail.com',
        '$2y$10$yTzKL1F78GJJ9X68drBoauAi.FiH0pjp4.K8dwcyY/2JwHIx32x4m',
        'admin',
        '2023-06-13'
    );
...
ALTER TABLE `candidate` ADD PRIMARY KEY (`nis`);
...
ALTER TABLE
    `vote` MODIFY `id_vote` int(11) NOT NULL AUTO_INCREMENT;
